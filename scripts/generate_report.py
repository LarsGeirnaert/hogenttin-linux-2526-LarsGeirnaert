...
# Afbeeldingen (we verwijzen relatief, want ze staan in dezelfde map als de md)
...
# Engelse → Nederlandse dagen vertaling & sortering
day_map = {
    "Monday": "Maandag", "Tuesday": "Dinsdag", "Wednesday": "Woensdag",
    "Thursday": "Donderdag", "Friday": "Vrijdag", "Saturday": "Zaterdag", "Sunday": "Zondag"
}
weekday_stats["weekday"] = weekday_stats["weekday"].map(day_map).fillna(weekday_stats["weekday"])

# Sorteren op juiste dagvolgorde
...
# --- Statistieken Berekenen (Identiek aan PDF) ---
...
with open(report_file, "w") as f:
    ...
    # 5. Weekdag Analyse (Grafiek + Tabel)
